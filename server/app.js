...
// /api/ihgg -> caught in this middleware -> throw some error
// -> errors only caught the links that the user is using
...
// post(/hotels) [req -> [] -> posthotel(controller) -> catch(error) -> res.error ]
module.exports = app;
